...
import com.onlinetalentsearchexam.model.viewresult.Message
import com.onlinetalentsearchexam.response.ViewResultResponse
import com.onlinetalentsearchexam.utils.Utils
import com.onlinetalentsearchexam.viewmodel.ViewResultViewModel
...
class ResultActivity : AppCompatActivity() {
    ...
    fun viewresult(){
        ...
        val requestBody: RequestBody = MultipartBody.Builder()
            ...
            .addFormDataPart("exam_taken_id", Global.exam_taken_id1)
            .build()
